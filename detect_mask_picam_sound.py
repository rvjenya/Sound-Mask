...
def sound_on():
    pygame.mixer.init()
    pygame.mixer.music.load("covidsound.wav")
...
def sound_off():
    ...
    pygame.mixer.music.load("thanks-mask.wav")
    # pygame.mixer.music.set_volume(1)
    pygame.mixer.music.play()
    # while pygame.mixer.music.get_busy():
...
def mask_on():
    wave_obj = sa.WaveObject.from_wave_file("covidsound.wav")
